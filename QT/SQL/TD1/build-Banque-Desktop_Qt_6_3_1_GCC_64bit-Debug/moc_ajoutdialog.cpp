...
#define QT_MOC_LITERAL(ofs, len) \
    uint(offsetof(qt_meta_stringdata_AjoutDialog_t, stringdata0) + ofs), len 
static const qt_meta_stringdata_AjoutDialog_t qt_meta_stringdata_AjoutDialog = {
    {
QT_MOC_LITERAL(0, 11) // "AjoutDialog"
...
const QMetaObject AjoutDialog::staticMetaObject = { {
    ...
    qt_meta_stringdata_AjoutDialog.offsetsAndSize,
    qt_meta_data_AjoutDialog,
    qt_static_metacall,
    nullptr,
qt_incomplete_metaTypeArray<qt_meta_stringdata_AjoutDialog_t
, QtPrivate::TypeAndForceComplete<AjoutDialog, std::true_type>
...
void *AjoutDialog::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_AjoutDialog.stringdata0))
