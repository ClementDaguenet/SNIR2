...
void Equilibreuse::on_actionImporter_mesures_brutes_triggered()
{
    ...
    QString leFichier = QFileDialog::getOpenFileName(this,
                                                    tr("Charger un fichier équilibrage brut"),
                                                    "/home/USERS/ELEVES/SNIR2021/cdaguenet/Documents/Github/QT/Fichiers_INI/Equilibreuse_TDs_Fichiers_Etudiants/data_set",
                                                    tr("Fichiers (*.mbr)")) ;
